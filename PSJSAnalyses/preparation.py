        ...
        with open(sh_file_all_name, 'w+') as g:
            ...
            for paralog in pairs:
                ...
                with open('./ShFiles/' + sh_file_name, 'w+') as f:
                    f.write('#!/bin/bash' + '\n')
                    f.write('python Run.py --paralog1 ' + paralog[0] + ' --paralog2 ' + paralog[1] + ' --L ' + str(tract_length) + ' --D ' + str(dim)\
            ...
            with open(sh_file_all_name, 'w+') as g:
                ...
                for paralog in pairs:
                    ...
                    with open('./ShFiles/' + sh_file_name, 'w+') as f:
                        f.write('#!/bin/bash' + '\n')
                        if allow_same_codon:
                            f.write('python Run.py --paralog1 ' + paralog[0] + ' --paralog2 ' + paralog[1] + ' --L ' + str(tract_length) + ' --heterogeneity --coding --samecodon --D ' + str(dim) + '\n')
                        else:
                            f.write('python Run.py --paralog1 ' + paralog[0] + ' --paralog2 ' + paralog[1] + ' --L ' + str(tract_length) + ' --heterogeneity --coding --no-samecodon --D ' + str(dim) + '\n')
                    g.write(sh_line + sh_file_name + '  \n')
