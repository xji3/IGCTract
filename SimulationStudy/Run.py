...
###### Now get HKY+PSJS-IGC estimates
    ...
    if rate_variation:
        save_file = './save/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/JS_HKY_'+ '_'.join(paralog) + '_' + IGC_pm.replace(' ', '_') + '_rv_nonclock_save.txt'
        log_file = './log/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/JS_HKY_'+ '_'.join(paralog) + '_' + IGC_pm.replace(' ', '_') + '_rv_nonclock_log.txt'
        summary_file = './summary/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/JS_HKY_'+ '_'.join(paralog) + '_' + IGC_pm.replace(' ', '_') + '_rv_nonclock_summary.txt'
        x_js = np.log([ 0.5, 0.5, 0.5,  4.35588244, 0.5, 5.0, 0.3])
    else:
        save_file = './save/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/JS_HKY_'+ '_'.join(paralog) + '_' + IGC_pm.replace(' ', '_') + '_nonclock_save.txt'
        log_file = './log/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/JS_HKY_'+ '_'.join(paralog) + '_' + IGC_pm.replace(' ', '_') + '_nonclock_log.txt'
        summary_file = './summary/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/JS_HKY_'+ '_'.join(paralog) + '_' + IGC_pm.replace(' ', '_') + '_nonclock_summary.txt'
    ...
    if rate_variation:
        log_file = './log/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_rv_sim_' + str(sim_num) + '_Tract_' + str(geo) + '_log.txt'
        summary_file = './summary/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_rv_sim_' + str(sim_num) + '_Tract_' + str(geo) + '_summary.txt'
        save_file = './save/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_rv_sim_' + str(sim_num) + '_Tract_' + str(geo) + '_log.txt'
        plot_file = './plot/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_rv_sim_' + str(sim_num) + '_Tract_' + str(geo) + '_lnL_1D_surface.txt'
    else:
        log_file = './log/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_sim_' + str(sim_num) + '_Tract_' + str(geo) + '_log.txt'
        summary_file = './summary/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_sim_' + str(sim_num) + '_Tract_' + str(geo) + '_summary.txt'
        save_file = './save/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_sim_' + str(sim_num) + '_Tract_' + str(geo) + '_log.txt'
        plot_file = './plot/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_sim_' + str(sim_num) + '_Tract_' + str(geo) + '_lnL_1D_surface.txt'
...
##    PSJS_IGC.get_individual_summary(summary_file)
##
##    log_p_list = np.log(1.0/np.array(range(1, 500)))
##    PSJS_IGC.plot_tract_p(log_p_list, plot_file)
