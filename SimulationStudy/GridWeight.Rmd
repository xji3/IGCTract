...
#weight.scheme <- outer(p.list, n.list, FUN=function(a, b) (1-a)^b) %*% diag(1.0/pair.diff.counts)
#weight.scheme <- outer(p.list, n.list, FUN=function(a, b) 1.0/a/b)
