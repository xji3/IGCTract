...
###### Now get HKY+PSJS-IGC estimates
    ...
    for guess_iter in range(len(guess_tract_list)):
        ...
        if rate_variation:
            log_file = './log/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_rv_sim_' + \
                       str(sim_num) + '_Tract_' + str(geo) + '_guess_' + str(guess_tract) + '_log.txt'
            summary_file = './summary/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_rv_sim_' \
                           + str(sim_num) + '_Tract_' + str(geo) + '_guess_' + str(guess_tract) + '_summary.txt'
            save_file = './save/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_rv_sim_'\
                        + str(sim_num) + '_Tract_' + str(geo) + '_guess_' + str(guess_tract) + '_log.txt'
            plot_file = './plot/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_rv_sim_' \
                        + str(sim_num) + '_Tract_' + str(geo) + '_guess_' + str(guess_tract) + '_lnL_1D_surface.txt'
        else:
            log_file = './log/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_sim_' \
                       + str(sim_num) + '_Tract_' + str(geo)  + '_guess_' + str(guess_tract) + '_log.txt'
            summary_file = './summary/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_sim_' \
                           + str(sim_num) + '_Tract_' + str(geo)  + '_guess_' + str(guess_tract) +  '_summary.txt'
            save_file = './save/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_sim_' \
                        + str(sim_num) + '_Tract_' + str(geo)  + '_guess_' + str(guess_tract) +  '_log.txt'
            plot_file = './plot/Tract_' + str(geo) + '/sim_' + str(sim_num) +'/PSJS_HKY_sim_' \
                        + str(sim_num) + '_Tract_' + str(geo)  + '_guess_' + str(guess_tract) +  '_lnL_1D_surface.txt'
