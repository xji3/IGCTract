...
if __name__ == '__main__':
    ...
    sh_line = 'sbatch -o PSJS-%j.out --mail-type=FAIL --mail-user=xji3@ncsu.edu ./ShFiles/Sim_'
    for geo in mean_tract_list:
    ...
    sh_line = 'sbatch -o HKY-%j.out --mail-type=FAIL --mail-user=xji3@ncsu.edu ./ShFiles/Sim_'
    for geo in mean_tract_list:
