...
###### Check MLE
    ...
    IGC_pm = 'One rate'
    rate_variation = True
    save_file = './save/YDR418W_YEL054C_HKY_rv_IGC_nonclock_save.txt'
...
##            seq_file = './TenthTau/Tract_' + str(geo) + '_HKY/sim_' + str(sim_num) + '/YDR418W_YEL054C_sim_' + str(sim_num) + '.fasta'
##            IGC_log_file = './TenthTau/Tract_' + str(geo) + '_HKY/sim_' + str(sim_num) + '/YDR418W_YEL054C_sim_' + str(sim_num) + '_IGC.log'
##            PM_log_file = './TenthTau/Tract_' + str(geo) + '_HKY/sim_' + str(sim_num) + '/YDR418W_YEL054C_sim_' + str(sim_num) + '_PM.log'
##
##            pm_model_name = 'HKY'
##            #x_pm = np.log([0.4, 0.5, 0.2, 9.2, 1.0])
##            x_pm = test_JS.jsmodel.x_pm
...
##            test.output_seq()
##
##            test.seq_file = './TenthTau/Tract_' + str(geo) + '_HKY/sim_' + str(sim_num) + '/YDR418W_YEL054C_sim_' + str(sim_num) + '_newformat.fasta'
##            test.output_seq(True)
...
##    sim_num = 1
            ...
            seq_file = './HalfTau/Tract_' + str(geo) + '_HKY/sim_' + str(sim_num) + '/YDR418W_YEL054C_sim_' + str(sim_num) + '.fasta'
            IGC_log_file = './HalfTau/Tract_' + str(geo) + '_HKY/sim_' + str(sim_num) + '/YDR418W_YEL054C_sim_' + str(sim_num) + '_IGC.log'
            PM_log_file = './HalfTau/Tract_' + str(geo) + '_HKY/sim_' + str(sim_num) + '/YDR418W_YEL054C_sim_' + str(sim_num) + '_PM.log'
        ...
        ##                       -6.459940982759793116e+00]
            ...
            test.seq_file = './HalfTau/Tract_' + str(geo) + '_HKY/sim_' + str(sim_num) + '/YDR418W_YEL054C_sim_' + str(sim_num) + '_newformat.fasta'
            test.output_seq(True)
