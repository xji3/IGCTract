...
Force.HKY.rv.nonclock.summary <- NULL
...
# PSJS.HKY.rv.guess1.nonclock.summary <- NULL
# PSJS.HKY.rv.guess2.nonclock.summary <- NULL
# for (pair in finished.pairs){
#   summary.file.name <- paste("PSJS_HKY", pair, "One_rate_Guess_1_rv_SCOK_nonclock_summary.txt", sep = "_")
#   summary_file <- paste("./summary/", summary.file.name, sep = "")
#   summary_mat <- read.summary.mat(summary_file, pair)
#   PSJS.HKY.rv.guess1.nonclock.summary <- cbind(PSJS.HKY.rv.guess1.nonclock.summary, summary_mat)  
#   
#   summary.file.name <- paste("PSJS_HKY", pair, "One_rate_Guess_2_rv_SCOK_nonclock_summary.txt", sep = "_")
#   summary_file <- paste("./summary/", summary.file.name, sep = "")
#   summary_mat <- read.summary.mat(summary_file, pair)
#   PSJS.HKY.rv.guess2.nonclock.summary <- cbind(PSJS.HKY.rv.guess2.nonclock.summary, summary_mat)
# }
...
Now plot triangular lnL increase for pairs
...
#     image.plot(1:dim(PSJS.rv.mat)[1], 1:dim(PSJS.rv.mat)[2], diff.lnL.mat, breaks = brk, col = c("white", "red"),#rainbow(2),
...
03232017 construct a table for my talk
